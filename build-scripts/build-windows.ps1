...
$PatchFile = Join-Path $ScriptDir "freetds-cslib.patch"
...
$ReleaseFiles = @(
    @{ Pattern = "src\cslib\Release\cs.dll"; Dest = "bin\x64\Release" },
    @{ Pattern = "src\cslib\Release\cs.lib"; Dest = "lib\x64\Release" },
    @{ Pattern = "src\cslib\Release\cs.pdb"; Dest = "bin\x64\Release" }
)
...
$DebugFiles = @(
    @{ Pattern = "src\cslib\Debug\cs.dll"; Dest = "bin\x64\Debug" },
    @{ Pattern = "src\cslib\Debug\cs.lib"; Dest = "lib\x64\Debug" },
    @{ Pattern = "src\cslib\Debug\cs.pdb"; Dest = "bin\x64\Debug" },
    @{ Pattern = "src\cslib\Debug\cs.ilk"; Dest = "bin\x64\Debug" }
)
