...
#   --patch-file    Path to patch file (default: build-scripts/freetds-cslib.patch)
...
if [ -z "$PATCH_FILE" ]; then
    PATCH_FILE="$SCRIPT_DIR/freetds-cslib.patch"
fi
...
if [ -f "src/cslib/CMakeLists.txt" ] && [ -f "include/freetds/export.h" ]; then
    echo "Patch appears to already be applied (cslib files exist)."
